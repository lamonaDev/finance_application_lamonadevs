...
export default function LineChartSector(properties) {
    return (
        <section className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 h-auto min-h-[30vh]">
            <h1 className="text-center px-6 py-2 bg-emerald-300 w-fit mx-auto rounded-2xl shadow-2xl mb-15 text-sm sm:text-base md:text-lg lg:text-xl">
