...
const Nav = () => {
    return (
    <nav className="bg-emerald-300 flex justify-center items-center p-3 mx-auto m-5 max-w-[700px] rounded-3xl sticky top-3 shadow-2xl xl:min-w-[1000px] md:min-w-[600px]">
    <ul className="text-white flex gap-x-10 xl:gap-x-20">
        <li className="relative table-cell py-1">
